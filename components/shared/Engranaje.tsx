...
const Engranaje = () => {
    useEffect(() => {
        ...
        // Selecciona el elemento SVG por su id o clase, si es necesario
        const engranaje = document.getElementById('engranaje');
    
        // Agrega la animación al timeline
        tl.to(engranaje, { rotation: 360, duration: 30 });
    
        // Pausa la animación al montar el componente
        tl.pause();
  ...
  return (
    <svg id="engranaje" version="1.0" xmlns="http://www.w3.org/2000/svg"
